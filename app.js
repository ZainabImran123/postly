...
if (!data.length) {
  posts.innerHTML = `
    <div class="d-flex flex-column justify-content-center align-items-center py-5">
      ...
      <p class="text-muted">
        There is no post matching your search.
      </p>
...
<div class="card-header">
    ...
    <small class="user-email">
        ...
        <div
          class="card-body"
          style="background-image:url(${post.bg_img || "images/first.jpg"})"
        >
  ...
  try {
    ...
    if (post.user_id !== user.id) {
      ...
      Swal.fire({
        icon: "error",
        title: "Access Denied",
        text: "You can delete only your own posts."
      });
  ...
  try {
    ...
    if (user.id !== post_id) {
      ...
      Swal.fire({
        icon: "error",
        title: "Access Denied",
        text: "You can edit only your own posts."
      });
    ...
    // Selected background
    cardBg = bg_img || "images/first.jpg";
